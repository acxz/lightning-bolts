...
@under_review()
class MLPRegression(LightningModule):
    """
    Multi Layer Perceptron regression model implementing -
...
def cli_main() -> None:
    ...
    parser = MLPRegression.add_model_specific_args(parser)
    parser = Trainer.add_argparse_args(parser)
    args = parser.parse_args()

    # model
    model = MLPRegression(input_dim=10, l1_strength=1, l2_strength=1)
    # model = MLPRegression(**vars(args))
